...
# 8 methods in paper Table 1 — NO Mahalanobis (paper π0+LIBERO column omits it)
ALL_METHODS = [
...
def main():
    ...
    print(f"  hs:      {len(eps_hs)} tasks, "
          f"{sum(len(v) for v in eps_hs.values())} eps")
    ...
    for method in args.methods:
        ...
        for split in args.splits:
            ...
            for seed in seed_list:
                ...
                f1cp    = M.f1_at_alpha(test_r, val_r, task_min,
